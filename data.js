...
const NODES = [
  ...
  ,
  {
    id: "raimundo_nogueira",
    name: "Raimundo Neto e Silva Nogueira Lima",
    type: "POLITICO",
    role: "Irmão de Ciro Nogueira — suposto operador de propina",
    summary: "Irmão do senador Ciro Nogueira e ex-secretário parlamentar de seu gabinete. Alvo da 5ª fase (07/05/2026). Segundo a PF, administrava formalmente a CNLF Empreendimentos Imobiliários, empresa que adquiriu 30% da Green Investimentos de Felipe Cançado Vorcaro por R$ 1 milhão — valor estimado pela CVM em R$ 13 milhões. O deságio de R$ 12 mi é apontado como mecanismo dissimulado de transferência de vantagem ao núcleo político de Ciro Nogueira. Obrigado a usar tornozeleira eletrônica, entregar passaporte e proibido de contato com investigados.",
    details: [
      "CNLF Empreendimentos adquiriu 30% da Green Investimentos por R$ 1 mi (valor de mercado: R$ 13 mi).",
      "Três meses após a compra, a participação já rendeu R$ 720 mil em dividendos — valor próximo ao total pago.",
      "Operação mantida como contrato de gaveta para contornar restrições do acordo de acionistas.",
  ...
  {
    id: "green_investimentos",
    name: "Green Investimentos S.A.",
    type: "FINANCEIRO",
    role: "Empresa de Felipe Cançado Vorcaro — veículo de propina a Ciro Nogueira",
    summary: "Empresa presidida por Felipe Cançado Vorcaro (primo de Daniel). Segundo a PF, 30% de sua participação foi vendida à CNLF (irmão de Ciro Nogueira) por R$ 1 milhão, quando o valor de mercado era R$ 13 milhões. O deságio de R$ 12 mi é investigado como propina disfarçada. Atividades suspensas pelo STF junto com CNLF, BRGD S.A. e Green Energia FIP.",
    details: [
      "Detinha participação na Trinity Energias Renováveis S.A., que distribuiu R$ 2,4 mi em dividendos anuais.",
...
const EDGES = [
  ...
  // Raimundo Nogueira e Green Investimentos
  { from: "ciro_nogueira", to: "raimundo_nogueira", label: "irmão — suposto operador formal do esquema" },
  { from: "raimundo_nogueira", to: "green_investimentos", label: "CNLF comprou 30% por R$ 1 mi (valor: R$ 13 mi)" },
...
const TIMELINE = [
  ...
  {
    date: "07/05/2026",
    title: "5ª fase: Green Investimentos e irmão de Ciro Nogueira com tornozeleira",
    phase: "Fase 5",
